      ...
      <div className='relative h-auto w-auto flex flex-col'>
        ...
        <div className='relative opacity-100 z-20 grid items-center justify-items-center nike-container'>
          <div className='grid item-center justify-items-center mt-28 md:mt-24'>
            ...
            <div className='grid items-center absolute top-[33vh] lg:top-[27vh] right-0 gap-10'>
          ...
          <div className='flex items-center'>
            <img src={img} alt='here-img/img' className='w-auto h-[45vh] lg:h-[35vh] md:h-[31vh] sm:h-[21vh] xsm:h-[19vh] transitions-theme -rotate-[25deg] hover:rotate-0 cursor-pointer object-fill' />
          </div>
        </div>
      </div>
    </>
