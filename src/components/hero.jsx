  ...
  return (
    <>
      <div className='relative h-auto w-auto flex flex-col'>
        ...
        <div className='relative placeholder-opacity-100 z-20 grid items-center justify-items-center nike-container'>
          ...
          <div className=''>
            <img src={img} alt='here-img/img' className='w-auto h-[45vh] lg:h-[35vh] md:h-[31vh] sm:h-[21vh] xsm:h-[19vh] transition-theme' />
          </div>
        </div>
      </div>
    </>
